...
# coerce the gender variable to numeric
eusilc$one_two <- as.numeric( eusilc$rb090 == "female" ) + 1

# sort the dataset based on gender
eusilc <- eusilc[ order( eusilc$one_two ) , ]
...
By default, the `convey::svygpg` function comes close to the results of `vardpoor::lingpg`.  However, the measures of uncertainty do not line up, because `library(vardpoor)` defaults to the ultimate cluster method.  This can be replicated with an alternative setup of the `survey.design` object.
