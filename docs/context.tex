...
Burgenland       Burgenland 0.1953984 0.017786939
Carinthia         Carinthia 0.1308627 0.012043787
Lower Austria Lower Austria 0.1384362 0.006363799
Salzburg           Salzburg 0.1378734 0.010838535
Styria               Styria 0.1437464 0.007283161
Tyrol                 Tyrol 0.1530819 0.010588028
Upper Austria Upper Austria 0.1088977 0.005331438
Vienna               Vienna 0.1723468 0.007705631
Vorarlberg       Vorarlberg 0.1653731 0.011342607
\end{verbatim}
...
\subsection{J-Divergence and Decomposition (svyjdiv,
...
In July 2006, Stephen Jenkins presented at the North American Stata
Users' Group Meetings on the Atkinson Index. His presentation can be
viewed
\href{http://econpapers.repec.org/scripts/redir.pf?u=http\%3A\%2F\%2Frepec.org\%2Fnasug2006\%2Fnasug2006_jenkins.zip;h=repec:boc:asug06:16}{here}.
...
\KeywordTok{download.file}\NormalTok{( }\StringTok{"http://econpapers.repec.org/scripts/redir.pf?u=http%3A%2F%2Frepec.org%2Fnasug2006%2Fnasug2006_jenkins.zip;h=repec:boc:asug06:16"} \NormalTok{, tf , }\DataTypeTok{mode =} \StringTok{'wb'} \NormalTok{)}
...
Replicate the author's survey design statement from stata code into R
code:
...
\CommentTok{# . * account for clustering within HHs }
\CommentTok{# . version 8: svyset [pweight = wgt], psu(hrn)}
\CommentTok{# pweight is wgt}
\CommentTok{# psu is hrn}
\CommentTok{# construct an}
...
\CommentTok{# . svyatk x if year == 1981}
 
\CommentTok{# Warning: x has 20 values = 0. Not used in calculations}


\CommentTok{# Complex survey estimates of Atkinson inequality indices}
 
\CommentTok{# pweight: wgt                                   Number of obs    = 9752}
\CommentTok{# Strata: <one>                                  Number of strata = 1}
\CommentTok{# PSU: hrn                                       Number of PSUs   = 7459}
                                               \CommentTok{# Population size  = 54766261}
\CommentTok{# ---------------------------------------------------------------------------}
\CommentTok{# Index    |  Estimate   Std. Err.      z      P>|z|     [95% Conf. Interval]}
\CommentTok{# ---------+-----------------------------------------------------------------}
\CommentTok{# A(0.5)   |  .0543239   .00107583    50.49    0.000      .0522153   .0564324}
\CommentTok{# A(1)     |  .1079964   .00245424    44.00    0.000      .1031862   .1128066}
\CommentTok{# A(1.5)   |  .1701794   .0066943    25.42    0.000       .1570588      .1833}
\CommentTok{# A(2)     |  .2755788   .02597608    10.61    0.000      .2246666    .326491}
\CommentTok{# A(2.5)   |  .4992701   .06754311     7.39    0.000       .366888   .6316522}
\CommentTok{# ---------------------------------------------------------------------------}
...
\CommentTok{# . svyatk x if year == 1981 & x >= 1}

\CommentTok{# Complex survey estimates of Atkinson inequality indices}
 
\CommentTok{# pweight: wgt                                   Number of obs    = 9748}
\CommentTok{# Strata: <one>                                  Number of strata = 1}
\CommentTok{# PSU: hrn                                       Number of PSUs   = 7457}
                                               \CommentTok{# Population size  = 54744234}
\CommentTok{# ---------------------------------------------------------------------------}
\CommentTok{# Index    |  Estimate   Std. Err.      z      P>|z|     [95% Conf. Interval]}
\CommentTok{# ---------+-----------------------------------------------------------------}
\CommentTok{# A(0.5)   |  .0540059   .00105011    51.43    0.000      .0519477   .0560641}
\CommentTok{# A(1)     |  .1066082   .00223318    47.74    0.000      .1022313   .1109852}
\CommentTok{# A(1.5)   |  .1638299   .00483069    33.91    0.000       .154362   .1732979}
\CommentTok{# A(2)     |  .2443206   .01425258    17.14    0.000      .2163861   .2722552}
\CommentTok{# A(2.5)   |   .394787   .04155221     9.50    0.000      .3133461   .4762278}
\CommentTok{# ---------------------------------------------------------------------------}
...
\subsection{Replicating Barabesi et al.
(2016)}\label{replicating-barabesi-et-al.-2016}
...
\caption{\label{tab:unnamed-chunk-23}Here is a nice table!}
\centering
