...
Burgenland       Burgenland 0.1953984 0.018689203
Carinthia         Carinthia 0.1308627 0.009553109
Lower Austria Lower Austria 0.1384362 0.007117437
Salzburg           Salzburg 0.1378734 0.012108102
Styria               Styria 0.1437464 0.007934822
Tyrol                 Tyrol 0.1530819 0.010363268
Upper Austria Upper Austria 0.1088977 0.006547004
Vienna               Vienna 0.1723468 0.007168595
Vorarlberg       Vorarlberg 0.1653731 0.011342068
\end{verbatim}
...
\item
  ...
  \item
    Therefore, the reference curve is
    \[L(p) = 0 \text{ } \forall p < 1\] and
    \[L(p) = 1 \text{ if } p = 1 \text{.}\]
  \end{itemize}
\end{itemize}
...
The estimation procedures are based in the equation set out in
\citep{kovacevic1997}:
...
Yet, this formula is used to calulate specific points of the curve and
their respective SEs. The formula to plot an approximation of the
continous empirical curve comes from \citep{lerman1989}.
...
The minimun value \(A\) assumes is \(\sqrt{2}\) and the maximum is
...
svyzenga: \citep{barabesi2016} and \citep{langel2012} and
\citep{deville1999}

svyzengacurve: \citep{barabesi2016} and \citep{langel2012} and
\citep{deville1999} and \citep{polisicchio2011}
...
\KeywordTok{print}\NormalTok{( page_ten )}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
##      k         MO        seMO          H         seH         A         seA
## 1  0.1 0.36990782 0.005305855 0.80820696 0.008316807 0.4576895 0.004573443
## 2  0.2 0.36990782 0.005305855 0.80820696 0.008316807 0.4576895 0.004573443
## 3  0.3 0.36990782 0.005305855 0.80820696 0.008316807 0.4576895 0.004573443
## 4  0.4 0.18658935 0.006812294 0.25825156 0.009245464 0.7225101 0.005174483
## 5  0.5 0.18658935 0.006812294 0.25825156 0.009245464 0.7225101 0.005174483
## 6  0.6 0.18658935 0.006812294 0.25825156 0.009245464 0.7225101 0.005174483
## 7  0.7 0.04326494 0.004297766 0.04326494 0.004297766 1.0000000 0.000000000
## 8  0.8 0.04326494 0.004297766 0.04326494 0.004297766 1.0000000 0.000000000
## 9  0.9 0.04326494 0.004297766 0.04326494 0.004297766 1.0000000 0.000000000
## 10 1.0 0.04326494 0.004297766 0.04326494 0.004297766 1.0000000 0.000000000
\end{verbatim}
