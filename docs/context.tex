...
\chapter{Complex surveys and statistical inference}\label{survey}
...
\subsection{Zenga Index and Curve (svyzenga and
...
\subsection{Generalized Entropy and Decomposition (svygei and
svygeidec)}\label{generalized-entropy-and-decomposition-svygei-and-svygeidec}

\subsection{J-Divergence Entropy and Decomposition (svyjdiv and
