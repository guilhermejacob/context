...
Burgenland       Burgenland 0.1953984 0.017377608
Carinthia         Carinthia 0.1308627 0.013690891
Lower Austria Lower Austria 0.1384362 0.005548198
Salzburg           Salzburg 0.1378734 0.010603019
Styria               Styria 0.1437464 0.007791588
Tyrol                 Tyrol 0.1530819 0.009438864
Upper Austria Upper Austria 0.1088977 0.005519586
Vienna               Vienna 0.1723468 0.008816556
Vorarlberg       Vorarlberg 0.1653731 0.011700717
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{( headcount_81 <-}\StringTok{ }\KeywordTok{svyfgt}\NormalTok{( ~}\StringTok{ }\NormalTok{eybhc0 , }\KeywordTok{subset}\NormalTok{( z , year ==}\StringTok{ }\DecValTok{1981} \NormalTok{) , }\DataTypeTok{g =} \DecValTok{0} \NormalTok{, }\DataTypeTok{abs_thresh =} \NormalTok{unwtd_arpt81 ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{( headcount_85 <-}\StringTok{ }\KeywordTok{svyfgt}\NormalTok{( ~}\StringTok{ }\NormalTok{eybhc0 , }\KeywordTok{subset}\NormalTok{( z , year ==}\StringTok{ }\DecValTok{1985} \NormalTok{) , }\DataTypeTok{g =} \DecValTok{0} \NormalTok{, }\DataTypeTok{abs_thresh =} \NormalTok{unwtd_arpt85 ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{( headcount_91 <-}\StringTok{ }\KeywordTok{svyfgt}\NormalTok{( ~}\StringTok{ }\NormalTok{eybhc0 , }\KeywordTok{subset}\NormalTok{( z , year ==}\StringTok{ }\DecValTok{1991} \NormalTok{) , }\DataTypeTok{g =} \DecValTok{0} \NormalTok{, }\DataTypeTok{abs_thresh =} \NormalTok{unwtd_arpt91 ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{( norm_pov_81 <-}\StringTok{ }\KeywordTok{svyfgt}\NormalTok{( ~}\StringTok{ }\NormalTok{eybhc0 , }\KeywordTok{subset}\NormalTok{( z , year ==}\StringTok{ }\DecValTok{1981} \NormalTok{) , }\DataTypeTok{g =} \DecValTok{1} \NormalTok{, }\DataTypeTok{abs_thresh =} \NormalTok{unwtd_arpt81 ) )}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tab:unnamed-chunk-39}Here is a nice table!}
\centering
