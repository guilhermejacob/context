...
The \texttt{convey} library estimates measures of poverty, income
concentration, and wellbeing. There are two other \{R\} libraries
...
concentration in a population based on data collected from a complex
survey sample. Most surveys administered by government agencies or
larger research organizations utilize a sampling design that prevents
...
uncertainty in the dataset. For some examples of publicly-available
complex survey data sets, see \href{}{http://asdfree.com}.
...
\texttt{convey} package will incorporate sample design automatically.
...
produce the linearized variables of some estimates that often enter in
the definition of measures of concentration and poverty. For example,
the \texttt{quantile} which is linearized by the function
...
Burgenland       Burgenland 0.1953984 0.017852756
Carinthia         Carinthia 0.1308627 0.010798080
Lower Austria Lower Austria 0.1384362 0.006263179
Salzburg           Salzburg 0.1378734 0.013277095
Styria               Styria 0.1437464 0.009228283
Tyrol                 Tyrol 0.1530819 0.010271417
Upper Austria Upper Austria 0.1088977 0.005374284
Vienna               Vienna 0.1723468 0.007352952
Vorarlberg       Vorarlberg 0.1653731 0.012949035
\end{verbatim}
...
\section{The Influence Function}\label{the-influence-function}
...
\includegraphics{context_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\caption{\label{tab:unnamed-chunk-15}Here is a nice table!}
\centering
