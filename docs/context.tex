...
Burgenland       Burgenland 0.1953984 0.016262342
Carinthia         Carinthia 0.1308627 0.011016574
Lower Austria Lower Austria 0.1384362 0.007776597
Salzburg           Salzburg 0.1378734 0.012686230
Styria               Styria 0.1437464 0.008283656
Tyrol                 Tyrol 0.1530819 0.009105411
Upper Austria Upper Austria 0.1088977 0.006166868
Vienna               Vienna 0.1723468 0.008294697
Vorarlberg       Vorarlberg 0.1653731 0.012950938
\end{verbatim}
...
\section{Comparisons to Other
Software}\label{comparisons-to-other-software}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SE_lin2 <-}\StringTok{ }\NormalTok{function(t,des)\{}
\NormalTok{variance<-survey::}\KeywordTok{svyrecvar}\NormalTok{(t/des$prob, des$cluster,des$strata, des$fpc,}
\DataTypeTok{postStrata =} \NormalTok{des$postStrata)}
\KeywordTok{sqrt}\NormalTok{(variance)}
\NormalTok{\}}


\NormalTok{des_eusilc <-}\StringTok{ }\KeywordTok{svydesign}\NormalTok{(}\DataTypeTok{ids =} \NormalTok{~rb030, }\DataTypeTok{strata =}\NormalTok{~db040,  }\DataTypeTok{weights =} \NormalTok{~rb050, }\DataTypeTok{data =} \NormalTok{eusilc)}

\NormalTok{des_eusilc_Tyrol <-}\StringTok{ }\KeywordTok{subset}\NormalTok{(des_eusilc, db040==}\StringTok{"Tyrol"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{incvar <-}\StringTok{ }\NormalTok{des_eusilc_Tyrol$variables$eqincome}
\NormalTok{lin.tot.conv <-}\StringTok{ }\NormalTok{incvar}
\KeywordTok{SE_lin2} \NormalTok{(lin.tot.conv, des_eusilc_Tyrol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ncom<-}\StringTok{ }\KeywordTok{names}\NormalTok{(des_eusilc$prob)}
\NormalTok{ind <-}\StringTok{ }\KeywordTok{names}\NormalTok{(des_eusilc_Tyrol$prob)}
\NormalTok{ID <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(des_eusilc))*}\StringTok{ }\NormalTok{(ncom %in%}\StringTok{ }\NormalTok{ind)}
\NormalTok{incvec <-}\StringTok{ }\NormalTok{des_eusilc$variables$eqincome}
\NormalTok{lin.tot.vardpoor <-}\StringTok{ }\NormalTok{incvec*ID}
\KeywordTok{SE_lin2} \NormalTok{(lin.tot.vardpoor, des_eusilc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{SE}\NormalTok{(}\KeywordTok{svytotal}\NormalTok{(~eqincome, des_eusilc_Tyrol))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{num <-}\StringTok{ }\NormalTok{incvar}
\NormalTok{den <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(des_eusilc_Tyrol))}
\NormalTok{Y <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(num*}\StringTok{ }\KeywordTok{weights}\NormalTok{(des_eusilc_Tyrol))}
\NormalTok{X <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(den*}\StringTok{ }\KeywordTok{weights}\NormalTok{(des_eusilc_Tyrol))}
\NormalTok{R <-}\StringTok{ }\NormalTok{Y/X}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lin.ratio.conv <-}\StringTok{ }\NormalTok{(}\DecValTok{1}\NormalTok{/X)*}\StringTok{ }\NormalTok{(num-R*den )}
\KeywordTok{SE_lin2} \NormalTok{(lin.ratio.conv, des_eusilc_Tyrol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{num <-}\StringTok{ }\NormalTok{incvec*ID}
\NormalTok{den <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, }\KeywordTok{nrow}\NormalTok{(des_eusilc))*ID}
\NormalTok{Y <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(num*}\StringTok{ }\KeywordTok{weights}\NormalTok{(des_eusilc))}
\NormalTok{X <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(den*}\StringTok{ }\KeywordTok{weights}\NormalTok{(des_eusilc))}
\NormalTok{R <-}\StringTok{ }\NormalTok{Y/X}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lin.ratio.vardpoor <-}\StringTok{ }\NormalTok{(}\DecValTok{1}\NormalTok{/X)*}\StringTok{ }\NormalTok{(num-R*den )}
\KeywordTok{SE_lin2} \NormalTok{(lin.ratio.vardpoor, des_eusilc)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{SE}\NormalTok{(}\KeywordTok{svymean}\NormalTok{(~eqincome,des_eusilc_Tyrol ))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{h <-}\StringTok{ }\KeywordTok{h_fun}\NormalTok{(incvar, }\KeywordTok{weights}\NormalTok{(des_eusilc_Tyrol))}
\NormalTok{q_alpha <-}\StringTok{ }\NormalTok{survey::}\KeywordTok{svyquantile}\NormalTok{(~eqincome, des_eusilc_Tyrol, .}\DecValTok{5}\NormalTok{,}
\DataTypeTok{method =} \StringTok{"constant"}\NormalTok{)}
\NormalTok{q_alpha <-}\StringTok{ }\KeywordTok{as.vector}\NormalTok{(q_alpha)}
\NormalTok{Fprime <-}\StringTok{ }\KeywordTok{densfun}\NormalTok{( ~eqincome , des_eusilc_Tyrol, q_alpha,h, }\DataTypeTok{fun =} \StringTok{"F"}\NormalTok{)}
\NormalTok{N <-}\StringTok{ }\KeywordTok{sum} \NormalTok{( }\KeywordTok{weights}\NormalTok{(des_eusilc_Tyrol))}
\NormalTok{lin.quant.conv <-}\StringTok{  }\NormalTok{-(}\DecValTok{1}\NormalTok{/(N *}\StringTok{ }\NormalTok{Fprime)) *}\StringTok{ }\NormalTok{((incvar <=}\StringTok{ }\NormalTok{q_alpha) -}\StringTok{ }\NormalTok{alpha)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{SE_lin2} \NormalTok{(lin.quant.conv, des_eusilc_Tyrol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lin.quant.vardpoor <-}\StringTok{  }\NormalTok{-(}\DecValTok{1}\NormalTok{/(N *}\StringTok{ }\NormalTok{Fprime)) *ID*}\StringTok{ }\NormalTok{((incvec <=}\StringTok{ }\NormalTok{q_alpha) -}\StringTok{ }\NormalTok{alpha)}

\KeywordTok{SE_lin2} \NormalTok{(lin.quant.vardpoor, des_eusilc)}
\end{Highlighting}
\end{Shaded}
...
Remarks: in all examples the results match. In these particular case,
the linearized variable for vardpoor the ID always enter as a factor.
There are formulas for the linearized variable in vardpoor where this is
not the case. When this hapen, the se estimates are different!
...
\StringTok{    }\KeywordTok{varpoord}\NormalTok{(}
        ...
        \DataTypeTok{type =} \StringTok{"linarpr"}
        
    \NormalTok{)}

\CommentTok{# all calculations produced by vardpoor::linarpr}
\NormalTok{varpoord_arpr_calculation$all_result}
\end{Highlighting}
\end{Shaded}
...
## 1:                 3.737369 13.90438 14.98405 0.07391608 0.07586194
##    var_srs_ca deff_sam deff_est     deff
## 1: 0.07391608 1.026325        1 1.026325
\end{verbatim}
...
By default, the \texttt{convey::svyarpr} function comes close to the
results of \texttt{vardpoor::linarpr}. However, the measures of
...
alternative setup of the \texttt{survey.design} object.
...
\CommentTok{# matches}
\KeywordTok{attr}\NormalTok{( }\KeywordTok{svyarpr}\NormalTok{( ~}\StringTok{ }\NormalTok{eqincome , des_eusilc_ultimate_cluster ) , }\StringTok{'var'} \NormalTok{) *}\StringTok{ }\DecValTok{10000}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{varpoord}\NormalTok{(}
        ...
        \DataTypeTok{type =} \StringTok{"linarpt"}
        
    \NormalTok{)}

\CommentTok{# all calculations produced by vardpoor::linarpt}
\NormalTok{varpoord_arpt_calculation$all_result}
\end{Highlighting}
\end{Shaded}
...
##    relative_margin_of_error CI_lower CI_upper var_srs_HT var_cur_HT
## 1:                0.9131066 10760.08 10958.39   2504.644   2559.442
##    var_srs_ca deff_sam deff_est     deff
## 1:   2504.644 1.021879        1 1.021879
\end{verbatim}
...
By default, the \texttt{convey::svyarpt} function comes close to the
results of \texttt{vardpoor::linarpt}. However, the measures of
uncertainty do not line up, because \texttt{library(vardpoor)} defaults
to the ultimate cluster method. This can be replicated with an
alternative setup of the \texttt{survey.design} object.
...
\CommentTok{# matches}
\KeywordTok{attr}\NormalTok{( }\KeywordTok{svyarpt}\NormalTok{( ~}\StringTok{ }\NormalTok{eqincome , des_eusilc_ultimate_cluster ) , }\StringTok{'var'} \NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{varpoord}\NormalTok{(}
        ...
        \DataTypeTok{type =} \StringTok{"linrmpg"}
        
    \NormalTok{)}

\CommentTok{# all calculations produced by vardpoor::linrmpg}
\NormalTok{varpoord_rmpg_calculation$all_result}
\end{Highlighting}
\end{Shaded}
...
##    relative_margin_of_error CI_lower CI_upper var_srs_HT var_cur_HT
## 1:                 5.963025 17.79988 20.05731  0.3166433  0.3316454
##    var_srs_ca deff_sam deff_est     deff
## 1:  0.3166433 1.047378        1 1.047378
\end{verbatim}
...
By default, the \texttt{convey::svyrmpg} function comes close to the
results of \texttt{vardpoor::linrmpg}. However, the measures of
uncertainty do not line up, because \texttt{library(vardpoor)} defaults
to the ultimate cluster method. This can be replicated with an
alternative setup of the \texttt{survey.design} object.
...
\CommentTok{# matches}
\KeywordTok{attr}\NormalTok{( }\KeywordTok{svyrmpg}\NormalTok{( ~}\StringTok{ }\NormalTok{eqincome , des_eusilc_ultimate_cluster ) , }\StringTok{'var'} \NormalTok{) *}\StringTok{ }\DecValTok{10000}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{varpoord}\NormalTok{(}
        ...
        \DataTypeTok{type =} \StringTok{"linpoormed"}
        
    \NormalTok{)}

\CommentTok{# all calculations produced by vardpoor::linpoormed}
\NormalTok{varpoord_poormed_calculation$all_result}
\end{Highlighting}
\end{Shaded}
...
##    relative_margin_of_error CI_lower CI_upper var_srs_HT var_cur_HT
## 1:                  1.62108 8661.019 8946.451   5064.071   5302.086
##    var_srs_ca deff_sam deff_est     deff
## 1:   5064.071 1.047001        1 1.047001
\end{verbatim}
...
By default, the \texttt{convey::svypoormed} function comes close to the
results of \texttt{vardpoor::linpoormed}. However, the measures of
uncertainty do not line up, because \texttt{library(vardpoor)} defaults
to the ultimate cluster method. This can be replicated with an
alternative setup of the \texttt{survey.design} object.
...
\CommentTok{# matches}
\KeywordTok{attr}\NormalTok{( }\KeywordTok{svypoormed}\NormalTok{( ~}\StringTok{ }\NormalTok{eqincome , des_eusilc_ultimate_cluster ) , }\StringTok{'var'} \NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{context_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\caption{\label{tab:unnamed-chunk-43}Here is a nice table!}
\centering
...
\StringTok{    }\KeywordTok{varpoord}\NormalTok{(}
        ...
        \DataTypeTok{type =} \StringTok{"linqsr"}
        
    \NormalTok{)}

\CommentTok{# all calculations produced by vardpoor::linqsr}
\NormalTok{varpoord_qsr_calculation$all_result}
\end{Highlighting}
\end{Shaded}
...
##    relative_margin_of_error CI_lower CI_upper  var_srs_HT  var_cur_HT
## 1:                 2.098819 3.886681 4.053328 0.001730759 0.001807323
##     var_srs_ca deff_sam deff_est     deff
## 1: 0.001730759 1.044238        1 1.044238
\end{verbatim}
...
By default, the \texttt{convey::svyqsr} function comes close to the
results of \texttt{vardpoor::linqsr}. However, the measures of
uncertainty do not line up, because \texttt{library(vardpoor)} defaults
to the ultimate cluster method. This can be replicated with an
alternative setup of the \texttt{survey.design} object.
...
\CommentTok{# matches}
\KeywordTok{attr}\NormalTok{( }\KeywordTok{svyqsr}\NormalTok{( ~}\StringTok{ }\NormalTok{eqincome , des_eusilc_ultimate_cluster ) , }\StringTok{'var'} \NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nlsw88$married <-}\StringTok{ }
\StringTok{    }\KeywordTok{factor}\NormalTok{( }
        \NormalTok{nlsw88$married , }
        \DataTypeTok{levels =} \DecValTok{0}\NormalTok{:}\DecValTok{1} \NormalTok{, }
...
\caption{\label{tab:unnamed-chunk-65}PDF Page 10 Replication}
\centering
...
\caption{\label{tab:unnamed-chunk-67}PDF Page 13 Replication}
\centering
\begin{tabular}[t]{lrrrrrrr}
\toprule
  & k & MO & seMO & H & seH & A & seA\\
...
\NormalTok{for( gs in }\DecValTok{0}\NormalTok{:}\DecValTok{3} \NormalTok{)\{}
...
\caption{\label{tab:unnamed-chunk-69}PDF Page 16 Replication}
\centering
...
A class of poverty measures is proposed in \citep{bourguignon2003},
...
\citep{vega2009} points out, it also weights the inequality among
