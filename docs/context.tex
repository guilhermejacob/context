...
Burgenland       Burgenland 0.1953984 0.016403458
Carinthia         Carinthia 0.1308627 0.010115762
Lower Austria Lower Austria 0.1384362 0.006681361
Salzburg           Salzburg 0.1378734 0.012686728
Styria               Styria 0.1437464 0.006831084
Tyrol                 Tyrol 0.1530819 0.009250335
Upper Austria Upper Austria 0.1088977 0.005833156
Vienna               Vienna 0.1723468 0.008048306
Vorarlberg       Vorarlberg 0.1653731 0.014714395
\end{verbatim}
...
otherwise. The \(n \times d\) matrix \(G^0\) will be referred to as
\emph{deprivation matrix}.

Each dimension receives a weight \(w_j\), so that the weighted sum of
multidimensional deprivation is the matrix multiplication of \(G^0\) by
the \(j \times 1\) vector \(W = [w_j]\). The \(n \times 1\) vector
\(C^\alpha = [c^\alpha_i]\) is the weighted sum of dimensional
deprivation scores, i.e.,
