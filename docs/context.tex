...
changed, modifying theories of justice underlying the idea of poverty.

As the concept and the ethics towards it change, so does its
measurement. From basic measures like the poverty rate to more complex
...
explored\footnote{For instance, see \citet{deville1999}, berger2003,
  \citet{bhat2007}, and \citet{osier2009}.}. These advances become even
more important given the recent efforts in poverty mapping, a analytical
method that combined poverty analysis and small area estimation, like
\citet{elbers2003} and \citet{bedi2007}.

The following subsections shows how poverty estimates and related
sampling error can be estimated using simple commands from the
\texttt{convey} package.
