...
Burgenland       Burgenland 0.1953984 0.017229282
Carinthia         Carinthia 0.1308627 0.011018319
Lower Austria Lower Austria 0.1384362 0.008170439
Salzburg           Salzburg 0.1378734 0.010367539
Styria               Styria 0.1437464 0.007484813
Tyrol                 Tyrol 0.1530819 0.009775361
Upper Austria Upper Austria 0.1088977 0.006278053
Vienna               Vienna 0.1723468 0.007363970
Vorarlberg       Vorarlberg 0.1653731 0.010067298
\end{verbatim}
...
The overall Alkire-Foster index is both dimensional and subgroup
decomposable. This way, it is possible to analyze how much each
dimension or group contribute to the general result.

The overall poverty measure can be seen as the weighted sum of each
group poverty measure, as in the formula below:
...
\caption{\label{tab:unnamed-chunk-42}PDF Page 10 Replication}
\centering
...
\caption{\label{tab:unnamed-chunk-44}PDF Page 13 Replication}
\centering
\begin{tabular}[t]{lrrrrrrr}
\toprule
  & k & MO & seMO & H & seH & A & seA\\
...
\KeywordTok{svyafcdec}\NormalTok{(}
    \NormalTok{~}\StringTok{ }\NormalTok{wage +}\StringTok{ }\NormalTok{collgrad +}\StringTok{ }\NormalTok{hours , }
    \DataTypeTok{by =} \NormalTok{~}\DecValTok{1} \NormalTok{, }
    \DataTypeTok{design =} \NormalTok{des_nlsw88 , }
    \DataTypeTok{cutoffs =} \KeywordTok{list}\NormalTok{( }\DecValTok{4} \NormalTok{, }\StringTok{'college grad'} \NormalTok{, }\DecValTok{26} \NormalTok{) , }
    \DataTypeTok{k =} \DecValTok{1}\NormalTok{/}\DecValTok{3} \NormalTok{, }
    \DataTypeTok{g =} \DecValTok{0} \NormalTok{,}
...
Replicate PDF page 21

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{svyby}\NormalTok{(}
    \NormalTok{~}\StringTok{ }\NormalTok{wage +}\StringTok{ }\NormalTok{collgrad +}\StringTok{ }\NormalTok{hours , }
    \NormalTok{~}\StringTok{ }\NormalTok{married , }
    \DataTypeTok{design =} \NormalTok{des_nlsw88 , }
    \NormalTok{svyafc , }
    \DataTypeTok{cutoffs =} \KeywordTok{list}\NormalTok{( }\DecValTok{4}\NormalTok{, }\StringTok{'college grad'} \NormalTok{, }\DecValTok{26} \NormalTok{) , }
    \DataTypeTok{k =} \DecValTok{1}\NormalTok{/}\DecValTok{3} \NormalTok{, }\DataTypeTok{g =} \DecValTok{0} \NormalTok{,}
...
\begin{verbatim}
##   married alkire-foster          se
## 0       0     0.3541407 0.008779380
## 1       1     0.3786722 0.006647037
\end{verbatim}
...
\KeywordTok{svyafcdec}\NormalTok{(}
    \NormalTok{~}\StringTok{ }\NormalTok{wage +}\StringTok{ }\NormalTok{collgrad +}\StringTok{ }\NormalTok{hours , }
    \DataTypeTok{by =} \NormalTok{~married , }
    \DataTypeTok{design =} \NormalTok{des_nlsw88 , }
    \DataTypeTok{cutoffs =} \KeywordTok{list}\NormalTok{( }\DecValTok{4} \NormalTok{, }\StringTok{'college grad'} \NormalTok{, }\DecValTok{26} \NormalTok{) , }
    \DataTypeTok{k =} \DecValTok{1}\NormalTok{/}\DecValTok{3} \NormalTok{, }
    \DataTypeTok{g =} \DecValTok{0} \NormalTok{,}
