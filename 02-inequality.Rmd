...
[add brief explanation about inequality measurement]
This chapter presents brief presentations on inequality measures, also providing replication examples where possible. It starts with the Lorenz curve and inequality measures derived from it, then the concept of entropy and the measures based on it are presented.
