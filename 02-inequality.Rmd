...
In July 2006, Stephen Jenkins presented at the North American Stata Users' Group Meetings on the Atkinson Index.  His presentation can be viewed [here](http://econpapers.repec.org/scripts/redir.pf?u=http%3A%2F%2Frepec.org%2Fnasug2006%2Fnasug2006_jenkins.zip;h=repec:boc:asug06:16).  The example below reproduces those statistics.
...
Replicate the author's survey design statement from stata code into R code:
```{r}
