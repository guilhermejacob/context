...
The quintile share ratio can be modified to a more general function of fractile share ratios. For instance, the Palma index is defined as the ratio between the share of the 10% richest over the share held by the poorest 40% and [@cobham2015] presents interesting arguments for its usage.
