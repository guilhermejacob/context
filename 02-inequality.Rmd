...
Although the most common results are based in [@kovacevic1997], the estimator adopted here is based in the partial sum $\widetilde{Y}_p$ set out in [@langel2012]:
