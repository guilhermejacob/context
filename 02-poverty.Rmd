...
```{r}
(
  cps_household_arpt <- svyarpt(~ htotval , cps_household_design)
)

(cps_household_arpt_by_sex <- svyby( ~ htotval , ~ sex , cps_household_design , svyarpt ) )
```
...
```{r}
(
  cps_family_arpt <- svyarpt(~ ftotval , cps_family_design)
)

(cps_family_arpt_by_sex <- svyby( ~ ftotval , ~ sex , cps_family_design , svyarpt ) )
```
