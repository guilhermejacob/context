...
# compute population value of the Watts index
( theta.pop <- 
    mean( ifelse( eusilcP$eqIncome <= 10000 , log( 10000 /  eusilcP$eqIncome ) , 0 )[ eusilcP$eqIncome > 0] , 
          na.rm = TRUE ) )
...
For additional usage examples of `svywatts`, type `?convey::svywatts` in the R console.
