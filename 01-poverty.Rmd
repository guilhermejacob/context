...
Denoting by $y$ the income variable, the at-risk-of-poverty threshold is defined by:

$$
arpt = 0.6 \times med(y)
$$
where, $med(y)$ is the median income. The at-risk-of-poverty rate is the share of persons with an income below the at-risk-of-poverty threshold (arpt).
