...
For the variance estimators, we estimate the PRB using the code below. 
Note that the bias is still relatively small, with absolute value of the Watts estimator's PRB below 1% and all four components of the decomposition below 5%.
