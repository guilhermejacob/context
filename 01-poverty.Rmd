...
```{r}
( headcount_81 <- svyfgt( ~ eybhc0 , subset( z , year == 1981 ) , g = 0 , abs_thresh = unwtd_arpt81 ) )

confint( headcount_81 , df = degf( subset( z , year == 1981 ) ) )

( headcount_85 <- svyfgt( ~ eybhc0 , subset( z , year == 1985 ) , g = 0 , abs_thresh = unwtd_arpt85 ) )

confint( headcount_85 , df = degf( subset( z , year == 1985 ) ) )

( headcount_91 <- svyfgt( ~ eybhc0 , subset( z , year == 1991 ) , g = 0 , abs_thresh = unwtd_arpt91 ) )
...
```{r}
( norm_pov_81 <- svyfgt( ~ eybhc0 , subset( z , year == 1981 ) , g = 1 , abs_thresh = unwtd_arpt81 ) )
