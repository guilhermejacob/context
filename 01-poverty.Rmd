...
where $I_w = \log(\theta/\mu_*)$ is the Watts poverty gap ratio^[ $\mu_*$ stands for the average income among the poor.] and $L_*$ is the Theil-L index of incomes among the poor. This can be estimated using the `svywattsdec` function.
